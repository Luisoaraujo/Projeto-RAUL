  ...
  iniciarDiv.addEventListener("click", () => {
    ...
    recognition.onresult = (event) => {
      for (let i = event.resultIndex; i < event.results.length; i++) {
        ...
        if (transcript.includes("calculadora") && index === 0) {
          resultadoCustom.innerText += "\n\nVocê acertou";
          pergunta1 = true;
        } else if (transcript.includes("brincadeira") && index === 1) {
          resultadoCustom.innerText += "\n\nVocê acertou";
          pergunta2 = true;
        } else if (transcript.includes("felicidade") && index === 2) {
          resultadoCustom.innerText += "\n\nVocê acertou";
          pergunta3 = true;
        } else if (transcript.includes("professora") && index === 3) {
          resultadoCustom.innerText += "\n\nVocê acertou";
          pergunta4 = true;
        } else {
          resultadoCustom.innerText += "\n\nTente novamente!";
